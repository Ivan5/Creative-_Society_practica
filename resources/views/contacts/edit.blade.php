...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            {!! Form::open(['route' => ['contacts.update',$contact], 'method' =>
            'PUT']) !!}
            ...
            <div class="row form-group">
                ...
                Form::text('ape_pat',$contact->ape_pat,['class' =>
                'form-control'] )!!}
            </div>
            <div class="row form-group">
                {!! Form::label('ape_mat', 'Apellido Materno')!!} {!!
                Form::text('ape_mat', $contact->ape_mat, ['class' =>
                'form-control'] )!!}
            </div>
            <div class="row form-group">
                {!! Form::label('fecha_nacimiento', 'Fecha Nacimiento')!!} {!!
                Form::date('fecha_nacimiento', $contact->fecha_nacimiento,
                ['class' => 'form-control'] )!!}
            </div>
            <div class="row form-group">
                <div class="col-sm-6">
